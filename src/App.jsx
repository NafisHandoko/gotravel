    ...
    <div className="App">
      <header className='bg-center bg-cover text-white' style={{ backgroundImage: `url(${Header})` }}>
        <div className='bg-black/50 min-h-screen'>
          <nav className='container mx-auto flex flex-row items-center justify-between w-full px-28 py-10'>
          ...
          <div className='min-h-[75vh] container mx-auto w-full flex flex-col items-center justify-center gap-y-5'>
      ...
      <section className='container mx-auto flex flex-col items-center mb-32'>
        <div className='flex flex-row items-center bg-white shadow-xl p-5 -translate-y-20'>
          <h2 className='font-bold text-xl mr-10'>Our popular destination</h2>
      ...
      <section className='container mx-auto flex flex-col items-center mb-32'>
        ...
        <div className='flex flex-row text-white gap-x-12'>
      ...
      <section className='container mx-auto flex flex-col items-center mb-32'>
        ...
        <div className='flex flex-col items-stretch w-full px-32'>
      ...
      <section className='bg-center bg-cover mb-32' style={{ backgroundImage: `url(${Contact})` }}>
        <div className='bg-black/50 text-white'>
          <div className='container mx-auto flex flex-col items-center min-h-[50vh] justify-center'>
            <h2 className='font-bold text-3xl mb-5'>Ready for an amazing trip?</h2>
            <button className='bg-primary py-3 px-5'>Contact Us Now!</button>
          </div>
        </div>
      </section>
      <section className='container mx-auto flex flex-row items-center px-32 mb-32'>
        <div className='w-1/2 flex flex-col'>
          <h3 className='font-bold text-2xl mb-5'>Various transportation you can choose</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tincidunt pulvinar tortor, dictum in pretium, eget semper quis. Feugiat.</p>
        </div>
        <div className='w-1/2 flex flex-row items-stretch justify-center'>
          <input type="text" className='bg-gray-200 text-gray-500 px-5 pr-8' placeholder='Enter your email' />
          <button className='bg-primary py-3 px-5 text-white'>Susbscribe</button>
        </div>
      </section>
      <footer className='bg-primary py-5 text-white px-28'>
        <div className='container mx-auto flex flex-row items-center'>
          <h3 className='font-bold text-3xl mr-auto'>Gotravel</h3>
          <p className='text-center'>Copyright 2022 Gotravel</p>
          <div className='flex flex-row items-center gap-x-4 ml-auto text-lg'>
